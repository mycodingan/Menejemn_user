...
<div class="container " style="border-radius: 10px">
    ...
    <div class="btn-group mb-3">
        <button type="button" class="btn btn-primary  mr-4 bg-dark" onclick="switchView('card')">Card </button>
        <button type="button" class="btn btn-primary  mr-4 bg-dark" onclick="switchView('table')">Table</button>
        <button class="btn  mr-4 bg-dark" onclick="cariAku('cari')">serch</button>
        <button type="button" class="btn btn-primary bg-dark" data-toggle="modal" data-target="#exampleModalCenter">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-down" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M1 3.5a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13a.5.5 0 0 1-.5-.5M8 6a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 0 1 .708-.708L7.5 12.293V6.5A.5.5 0 0 1 8 6" />
            </svg>
        </button>
        <button class=" text-decoration-none" type="button">
            <a href="{{ route('user.export') }}" class="btn  bg-dark" style="text-decoration: "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-up" viewBox="0 0 16 16">
